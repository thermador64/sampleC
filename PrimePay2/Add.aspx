<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="PrimePay2.Add" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:Button runat="server" Text="Add" ID="addButton" OnClick="submitEventMethod" />
